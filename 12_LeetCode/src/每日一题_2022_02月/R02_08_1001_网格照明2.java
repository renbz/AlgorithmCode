...
public class R02_08_1001_网格照明2 {

    public static void main(String[] args) {
        R02_08_1001_网格照明2 obj = new R02_08_1001_网格照明2();
        int[][] lamps = {{1, 1}};
        int[][] queries = {};
    ...
    private boolean check(int x, int y, int n, long point) {
    ...
    private void h_l_djx(int[] lamp, int n, boolean flag) {
        // 将亮着灯的所在行和列的灯加入Map中
        for (int i = 0; i < n; i++) {
            long point1 = hash(i, lamp[1]);
            long point2 = hash(lamp[0], i);
